...
RUN python3 -m pip install numpy scipy # For Python 3
...
CMD scons -j50 build/X86/gem5.opt; cd /code ; ./run_aessetup.sh ; export SPEC_PATH=/code; export BASE_DIR=/code ; /bin/bash