...
for j in {1..10}; do
	...
	/code/mirage/perf_analysis/gem5/build/X86/gem5.opt --outdir ${OUTDIR}/${stats} /code/mirage/perf_analysis/gem5/configs/example/spec06_config_aes_${key}.py --num-cpus=1 --mem-size=8GB --mem-type=DDR4_2400_8x8 \
